      ...
      <div className=" what-i-do-card  lg:h-[340px] p-4  lg:w-[300px] rounded-md ">
        <div className="mb-2 overflow-hidden  flex justify-center">
          <div className=" mb-2  h-[160px] w-[150px] ">
            <Image width={176} height={176} src={skill.image} alt="icon" className='  hover:scale-105 duration-250 in-sd-1 p-5 w-full h-full object-cover rounded-full '></Image>
          </div>

        </div>
        

        <div className="p-title mt-3">
